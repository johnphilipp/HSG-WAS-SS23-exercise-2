...
def astar_search(
    ...
    while open:
        ...
        (f, h, _tie, pop_node) = heapq.heappop(
            open
        )  # update this line to implement step 1
        ...
        pop_state = (
            pop_node.state
        )  # state in node, update this line to implement step 2
        ...
        if state_cost[pop_state] == pop_g:
            ...
            for op, succ_state in task.get_successor_states(pop_state):
                ...
                #    HINT: Use the SearchNode method make_child_node()succ_node = searchspace.make_child_node(pop_node, op, succ_state)
